...
import { LogoContainer, LogoImage, RegisterBody, RegisterButton, RegisterContainer, RegisterForm, RegisterHeader, RegisterInput, RegisterSelect, RegisterTitle } from './RegisterPage.styles';
...
export default function RegisterPage() {
    ...
    return (
      <RegisterBody>
        <RegisterHeader>
          <RegisterTitle>Search Hub</RegisterTitle>
        </RegisterHeader>
